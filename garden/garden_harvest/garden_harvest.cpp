// garden_harvest.cpp : Defines the entry point for the console application.
//
...
void print_usage()
{
	printf("USAGE: garden_harvest -session \"session id\" -start 0 -end 4\n");
}

bool parse(int argc, char* argv[], HARVEST_PARAMETERS* params)
{
	if (argc != 7)
		return false;
