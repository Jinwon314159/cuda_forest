...
struct fig_finest_fruit
{
	...
	double probability;
#else
	double probability[MAX_CELL_NUM];
#endif
};
...
public:
	...
	bool ready(unsigned int tr_cnt, unsigned int nu_cnt);
