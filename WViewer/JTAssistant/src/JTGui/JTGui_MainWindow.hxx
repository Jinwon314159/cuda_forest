...
public:
  ...
  void loadOSFile(const QString& theJtFileName, const QString& theBowFileName);
  void setOSExportPath(const QString& theSession, const QString& theColorPath, const QString& theDepthPath);
  void setOSMVPMatrix(const Eigen::Matrix4f& theMVP);
  void setOSExportMode(bool theMode, bool theEnableMultiShot);
  void makeOSScreenshot();
  void ImportCameraParams(const QString& theFileName, bool isOrtho);
...
private:
  ...
  //! Loads JT file into new scenegraph and creates 3d scene to visualize it.
  void loadFile(const QString& theJtFileName, const QString& theBowFileName);
...
private:
  ...
  bool	  isInExportMode;
  QString myLoadedFileName;
  QString myCameraFileName;
};
