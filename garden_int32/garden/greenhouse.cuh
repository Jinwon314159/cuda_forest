...
public:
	...
	fig_twig *twigs;
	bool dig_up_land(unsigned int tr_cnt, unsigned int br_cnt, unsigned int ep_cnt);
	bool dig_up_land_harvest(unsigned int tr_cnt, unsigned int br_cnt, unsigned int ep_cnt);
