...
bool fig_branch::dig_up(unsigned int parent_index, unsigned int branch_index, garden_truck *truck, unsigned int *truck_branch_index, unsigned int *truck_endpoint_index)
{
